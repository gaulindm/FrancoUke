...
def beginner_to_f2l_bridge(request):
    """
    ...
    breadcrumbs = [
        ...
        {'name': 'CFOP', 'url': reverse('francontcube:method_cfop')},
        {'name': 'De Débutant à F2L', 'url': ''},
    ]
    ...
    context = {
        ...
        'beginner_algorithm': beginner_algorithm,
        'second_layer_cases': second_layer_cases,
    ...
    return render(request, 'francontcube/methods/cfop/beginner_to_f2l.html', context)